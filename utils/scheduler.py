...
class CustomSchedule(tf.keras.optimizers.schedules.LearningRateSchedule):
    ...
    def __call__(self, step):
        initial_lr = ops.convert_to_tensor_v2_with_dispatch(self.initial_lr, name="initial_learning_rate")
        ...
        p = math_ops.floor(p)
        p = math_ops.pow(decay_rate, p)
        return math_ops.multiply(initial_lr, p, name="CustomDecay")
